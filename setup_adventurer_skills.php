...
<head>
    ...
    <style>
        ...
        .setup-card { background: #2d2d2d; border: 3px solid #d4af37; border-radius: 15px; padding: 1.5rem; width: 100%; max-width: 450px; font-size: 0.85rem; }
        ...
        .skill-field { width: 45px; background: #1a1a1a !important; color: white !important; border-color: #d4af37 !important; text-align: center; font-size: 0.9rem; border-radius: 5px; }
        .btn-plus-minus { background: #d4af37; color: #1a1a1a; border: none; width: 30px; height: 30px; border-radius: 5px; font-weight: bold; font-size: 1rem; }
